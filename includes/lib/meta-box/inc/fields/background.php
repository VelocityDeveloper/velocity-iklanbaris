...
class RWMB_Background_Field extends RWMB_Field {
	...
	public static function html( $meta, $field ) {
		...
		$image  = RWMB_File_Input_Field::normalize( array(
			...
			'placeholder' => __( 'Background Image', 'vsstemmart' ),
		) );
		...
		$repeat = RWMB_Select_Field::normalize( array(
			...
			'placeholder' => esc_html__( '-- Background Repeat --', 'vsstemmart' ),
			'options'     => array(
				'no-repeat' => esc_html__( 'No Repeat', 'vsstemmart' ),
				'repeat'    => esc_html__( 'Repeat All', 'vsstemmart' ),
				'repeat-x'  => esc_html__( 'Repeat Horizontally', 'vsstemmart' ),
				'repeat-y'  => esc_html__( 'Repeat Vertically', 'vsstemmart' ),
				'inherit'   => esc_html__( 'Inherit', 'vsstemmart' ),
			),
		) );
		...
		$position = RWMB_Select_Field::normalize( array(
			...
			'placeholder' => esc_html__( '-- Background Position --', 'vsstemmart' ),
			'options'     => array(
				'top left'      => esc_html__( 'Top Left', 'vsstemmart' ),
				'top center'    => esc_html__( 'Top Center', 'vsstemmart' ),
				'top right'     => esc_html__( 'Top Right', 'vsstemmart' ),
				'center left'   => esc_html__( 'Center Left', 'vsstemmart' ),
				'center center' => esc_html__( 'Center Center', 'vsstemmart' ),
				'center right'  => esc_html__( 'Center Right', 'vsstemmart' ),
				'bottom left'   => esc_html__( 'Bottom Left', 'vsstemmart' ),
				'bottom center' => esc_html__( 'Bottom Center', 'vsstemmart' ),
				'bottom right'  => esc_html__( 'Bottom Right', 'vsstemmart' ),
			),
		) );
		...
		$attachment = RWMB_Select_Field::normalize( array(
			...
			'placeholder' => esc_html__( '-- Background Attachment --', 'vsstemmart' ),
			'options'     => array(
				'fixed'   => esc_html__( 'Fixed', 'vsstemmart' ),
				'scroll'  => esc_html__( 'Scroll', 'vsstemmart' ),
				'inherit' => esc_html__( 'Inherit', 'vsstemmart' ),
			),
		) );
		...
		$size   = RWMB_Select_Field::normalize( array(
			...
			'placeholder' => esc_html__( '-- Background Size --', 'vsstemmart' ),
			'options'     => array(
				'inherit' => esc_html__( 'Inherit', 'vsstemmart' ),
				'cover'   => esc_html__( 'Cover', 'vsstemmart' ),
				'contain' => esc_html__( 'Contain', 'vsstemmart' ),
			),
		) );
