...
class RWMB_Core {
	...
	public function init() {
		load_plugin_textdomain( 'vsstemmart', false, plugin_basename( RWMB_DIR ) . '/languages/' );
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://docs.metabox.io">' . esc_html__( 'Documentation', 'vsstemmart' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/" style="color: #39b54a; font-weight: bold">' . esc_html__( 'Extensions', 'vsstemmart' ) . '</a>';
		return $links;
	}
